...
def upgrade():
    ...
    op.create_index(
        "ix_optimization_dataset_entries_dataset_id", "optimization_dataset_entries", ["dataset_id"], unique=False
    )
    op.create_index(
        "ix_optimization_dataset_entries_initial_molecule_id",
        "optimization_dataset_entries",
        ["initial_molecule_id"],
        unique=False,
    )
    op.create_index("ix_optimization_dataset_entries_name", "optimization_dataset_entries", ["name"], unique=False)
    op.create_table(
        "optimization_dataset_specifications",
        sa.Column("dataset_id", sa.Integer(), nullable=False),
        sa.Column("name", sa.String(), nullable=False),
    ...
    op.create_index(
        "ix_optimization_dataset_specifications_dataset_id",
        "optimization_dataset_specifications",
        ["dataset_id"],
        unique=False,
    )
    op.create_index(
        "ix_optimization_dataset_specifications_name", "optimization_dataset_specifications", ["name"], unique=False
    )
    op.create_index(
        "ix_optimization_dataset_specifications_specification_id",
        "optimization_dataset_specifications",
        ["specification_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_optimization_dataset_records_record_id", "optimization_dataset_records", ["record_id"], unique=False
    )
    ...
    for col in collections:
        ...
        for spec_name, spec in col_specs.items():
            ...
            conn.execute(
                sa.text(
                    """
                       INSERT INTO optimization_dataset_specifications (dataset_id, name, description, specification_id)
        ...
        conn.execute(
            sa.text(
                """
                   INSERT INTO optimization_dataset_entries (dataset_id, name, initial_molecule_id, additional_keywords, attributes)
        ...
        for ent_name, ent in col_records.items():
            for spec_name, record_id in ent["object_map"].items():
                conn.execute(
                    sa.text(
                        """
                           INSERT INTO optimization_dataset_records (dataset_id, entry_name, specification_name, record_id)
